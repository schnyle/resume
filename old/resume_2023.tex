...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}}r}
  ...
  \href{https://www.kvschneider.com}{\uline{kvschneider.com}} $|$ % row = 2, col = 1
...
\section{Projects}
  \resumeHeadingListStart{}
    \resumeTrioHeading{\textbf{Chess Is Hard} - \href{https://github.com/kvschneider0/chess}{\uline{GitHub}} - \href{https://youtu.be/43IuuSmvnHs}{\uline{Demo}} - \href{https://www.chess.kvschneider.com}{\uline{Live Site}}}
    {}{}
      \textit{Play chess with other users and save/view game data. Includes castling, en passant capture, pawn promotion, and all win/draw scenarios.}
      \resumeItemListStart{}
        \resumeItem{Created chess game logic from scratch using Python}
        \resumeItem{Designed a clean and modern website using React with Material UI}
        \resumeItem{Built a server using Flask to support the front-end and handle chess logic}
      \resumeItemListEnd{}
...
\resumeHeadingListStart{}
  ...
  \resumeQuadHeading{Private Company, Boulder, CO}{January 2022 -- September 2022}
...
\section{Education}
  \resumeHeadingListStart{}
    ...
    {Bachelor of Arts in Mathematics, \textit{magna cum laude}, GPA: 3.84}{}{Bachelor of Arts in Physics, GPA: 3.52}
